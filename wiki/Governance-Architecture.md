...
| NumberStringGet | Query | `GET /number-string/{number}` | Não | Conversão de número (0-10) para string em português |
| NumberTextGet | Query | `GET /number-text/{number}` | Não | Conversão de número (1, 2) para texto em português |
