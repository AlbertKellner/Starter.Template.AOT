---
title: "Claude — Recursos Avançados"
linkTitle: "Recursos Avançados"
weight: 50
description: "Frontmatter, agentes dedicados, contexto dinâmico, proteção"
---
...
- [Visão Geral do Claude](/Starter.Template.AOT/claude/visao-geral/) — Sistema de governança operacional e pipeline
- [Skills](/Starter.Template.AOT/claude/skills/) — Catálogo completo de skills disponíveis
- [Hooks](/Starter.Template.AOT/claude/hooks/) — Hooks configurados e comportamentos
- [Convenções e Restrições](/Starter.Template.AOT/claude/convencoes/) — Comportamentos obrigatórios
- [Arquitetura](/Starter.Template.AOT/governanca/arquitetura/) — Estrutura Vertical Slice e componentes
