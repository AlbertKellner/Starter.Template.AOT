...
linkTitle: "Convenções de Código"
weight: 30
description: "Nomenclatura, namespaces, variáveis, padrão de logging SNP-001"
---
...
- [Padrões de Desenvolvimento](/Starter.Template.AOT/governanca/padroes-desenvolvimento/) — padrões que usam estas convenções
