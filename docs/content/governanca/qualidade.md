...
linkTitle: "Qualidade"
weight: 100
description: "Tratamento de exceções, Problem Details"
---
...
Para mais detalhes sobre restrições e trade-offs do Native AOT, ver [Restrições e Decisões](/Starter.Template.AOT/governanca/decisoes/).

---

## Referências

- [Arquitetura](/Starter.Template.AOT/governanca/arquitetura/) — visão geral da arquitetura e localização do GlobalExceptionHandler
- [Restrições e Decisões](/Starter.Template.AOT/governanca/decisoes/) — restrições do Native AOT e componentes de compatibilidade
- [Segurança](/Starter.Template.AOT/governanca/seguranca/) — autenticação e tratamento de 401
- [Testes](/Starter.Template.AOT/governanca/testes/) — estratégia de testes unitários
