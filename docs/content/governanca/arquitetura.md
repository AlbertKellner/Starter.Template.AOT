...
weight: 10
description: "Estilo Vertical Slice, estrutura de pastas, componentes e fluxo de request"
---
...
- [Padrões de Desenvolvimento](/Starter.Template.AOT/governanca/padroes-desenvolvimento/) — padrões que determinam a organização
- [Segurança](/Starter.Template.AOT/governanca/seguranca/) — mecanismos de autenticação e autorização
- [Observabilidade](/Starter.Template.AOT/governanca/observabilidade/) — logging, tracing e métricas
- [Testes](/Starter.Template.AOT/governanca/testes/) — estratégia e padrões de teste
