---
title: "Restrições e Decisões"
linkTitle: "Decisões"
weight: 110
description: "Decisões arquiteturais, restrições AOT, evolução"
---
...
- [Arquitetura](/Starter.Template.AOT/governanca/arquitetura/) — visão geral da arquitetura e componentes
- [Padrões de Desenvolvimento](/Starter.Template.AOT/governanca/padroes-desenvolvimento/) — padrões técnicos adotados no projeto
- [Qualidade e Manutenção](/Starter.Template.AOT/governanca/qualidade/) — políticas de qualidade e tratamento de erros
