...
linkTitle: "Padrões de Desenvolvimento"
weight: 20
description: "Vertical Slice, CQRS, UseCase, Decorator, validação em Input"
---
...
- [Arquitetura](/Starter.Template.AOT/governanca/arquitetura/) — visão geral da estrutura do projeto
- [Convenções de Código](/Starter.Template.AOT/governanca/convencoes-codigo/) — nomenclatura e estilo de código
- [Integrações](/Starter.Template.AOT/governanca/integracoes/) — padrões de integração com APIs externas
