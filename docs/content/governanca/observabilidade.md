...
weight: 60
description: "Correlation ID, Serilog, Datadog Agent"
---
...
- [Arquitetura](/Starter.Template.AOT/governanca/arquitetura/) — fluxo de requisição com middlewares de observabilidade
- [Operação](/Starter.Template.AOT/governanca/operacao/) — portas, URLs e configuração de containers
- [Convenções de Código](/Starter.Template.AOT/governanca/convencoes-codigo/) — padrão de logging SNP-001
