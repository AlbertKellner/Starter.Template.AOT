...
linkTitle: "Operação"
weight: 90
description: "Pré-requisitos, configuração, build, Docker"
---
...
- [Health Check](/Starter.Template.AOT/dominio/features/health/) — detalhes do endpoint de verificação de disponibilidade
- [CI/CD e Deploy](/Starter.Template.AOT/governanca/ci-cd/) — pipelines de integração contínua
- [Observabilidade](/Starter.Template.AOT/governanca/observabilidade/) — Datadog Agent e configuração de métricas
