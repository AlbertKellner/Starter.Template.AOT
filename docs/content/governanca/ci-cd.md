...
linkTitle: "CI/CD"
weight: 70
description: "Pipelines de build, execução e validação"
---
...
- [Operação](/Starter.Template.AOT/governanca/operacao/) — pré-requisitos e configuração do ambiente
- [Health Check](/Starter.Template.AOT/dominio/features/health/) — endpoint validado pelos jobs de health check
- [Observabilidade](/Starter.Template.AOT/governanca/observabilidade/) — integração com Datadog para métricas e logs
