...
weight: 80
description: "Padrão Refit + Polly, Memory Cache, APIs externas"
---
...
- [Padrões de Desenvolvimento](/Starter.Template.AOT/governanca/padroes-desenvolvimento/) — padrões técnicos adotados
