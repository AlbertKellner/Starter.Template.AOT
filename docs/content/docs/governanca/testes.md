...
linkTitle: "Testes"
weight: 40
description: "Estratégia de testes, padrões e cobertura"
---
...
- [CI/CD](/Starter.Template.AOT/governanca/ci-cd/) — pipeline que executa os testes automaticamente
- [Convenções de Código](/Starter.Template.AOT/governanca/convencoes-codigo/) — padrões de logging testados
- [Padrões de Desenvolvimento](/Starter.Template.AOT/governanca/padroes-desenvolvimento/) — padrões que determinam a organização dos testes
