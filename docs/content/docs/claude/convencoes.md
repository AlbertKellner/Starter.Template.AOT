---
title: "Claude — Convenções e Restrições"
linkTitle: "Convenções"
weight: 40
description: "Comportamentos obrigatórios, linguagem, restrições"
---
...
- [Claude — Visão Geral](/Starter.Template.AOT/claude/visao-geral/)
- [Claude — Skills](/Starter.Template.AOT/claude/skills/)
- [Claude — Hooks](/Starter.Template.AOT/claude/hooks/)
