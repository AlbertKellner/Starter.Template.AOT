...
**Não requer autenticação.** Este endpoint é acessível publicamente e é explicitamente excluído da proteção por Bearer Token. Consulte [Segurança](/Starter.Template.AOT/governanca/seguranca/) para entender como a proteção funciona nos demais endpoints.
...
- [Segurança](/Starter.Template.AOT/governanca/seguranca/) — exceção à autenticação por Bearer Token
- [Observabilidade](/Starter.Template.AOT/governanca/observabilidade/) — integração com Datadog Agent
- [Arquitetura](/Starter.Template.AOT/governanca/arquitetura/) — posição no fluxo de request
