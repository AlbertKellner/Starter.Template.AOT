...
builder.Services.AddScoped<INumberToStringUseCase, NumberToStringUseCase>();
...
{
    [DynamicDependency(DynamicallyAccessedMemberTypes.All, typeof(NumberToStringEndpoint))]
