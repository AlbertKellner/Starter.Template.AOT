...
builder.Services.AddScoped<INumberStringGetByNumberUseCase, NumberStringGetByNumberUseCase>();
...
{
    [DynamicDependency(DynamicallyAccessedMemberTypes.All, typeof(NumberStringGetByNumberEndpoint))]
