...
| 7 | Todas as features possuem página correspondente na documentação Hugo (`docs/content/docs/dominio/features/`) | Cobertura documental |
...
| 20 | `docs/content/docs/governanca/arquitetura.md` lista todas as features implementadas | Completude documental |
| 21 | `docs/content/docs/governanca/arquitetura.md` lista todas as subpastas de `Infra/` | Completude documental |
| 22 | `docs/content/docs/governanca/arquitetura.md` lista todas as integrações de `Shared/ExternalApi/` | Completude documental |
...
| 37 | Páginas de feature em `docs/content/docs/dominio/features/` não contêm conteúdo de placeholder (`<!-- TODO:` ou `[Título da Funcionalidade]`) — stubs gerados pelo `--fix` devem ser preenchidos com conteúdo real antes do commit | Completude documental |
...
| # | Verificação | Categoria |
|---|---|---|
| 25 | Nenhuma página de feature órfã em `docs/content/docs/dominio/features/` (sem feature correspondente no código) | Higiene bidirecional |
...
| 31 | `docs/content/docs/dominio/regras-negocio.md` lista todas as RNs ativas | Completude documental |
...
- Check #7: cria stub de página Hugo em `docs/content/docs/dominio/features/` com template obrigatório e front-matter YAML
